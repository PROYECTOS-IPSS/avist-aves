...
| P3 | Navigation/UI foundation | P1 | Context7 | List/create/detail routes reachable; base states and empty shell. |
| P4 | Form and validation | P2,P3 | Context7 | Required fields, quantity >=1, feedback, save gating. |
